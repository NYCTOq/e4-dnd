...
const en: Record<string, string> = {
  ...
  "settings.language":"Language","settings.languageTitle":"Interface language","settings.languageNote":"Language changes immediately and does not modify character or ruleset data.","settings.turkish":"Türkçe","settings.english":"English"
