...
export const ENGLISH_TRANSLATIONS: Readonly<Record<string, string>> = {
  "nav.group.Oyuncu":"Player","nav.group.Kampanya":"Campaign","nav.group.Dünya":"World","nav.group.Kurallar":"Rules & Content","nav.group.Homebrew":"Homebrew","nav.group.Sistem":"System",
  "nav.skip":"Skip to main content","nav.sidebar":"Application menu","nav.main":"Main navigation","nav.mobile":"Mobile navigation","nav.home":"E4 D&D home","nav.more":"Menu","nav.all":"All menu","nav.choose":"Choose a section","nav.close":"Close menu",
