...
describe("character sheet rules",()=>{
 ...
 it("adds Jack of All Trades to an untrained bard skill",()=>{const c=makeCharacter({level:5,className:"Bard",skillProficiencies:[],abilities:{str:10,dex:10,con:10,int:10,wis:10,cha:16}});expect(getSkillBonus(c,"Arcana")).toBe(1);});
});
