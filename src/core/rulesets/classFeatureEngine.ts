...
export function getClassFeatureActions(className: string, level: number, ruleset: RulesetId): ClassFeatureAction[] {
  ...
  const actions: Record<string, ClassFeatureAction[]> = {
    ...
    paladin: [{ id: "lay-on-hands", name: "Lay on Hands", actionType: ruleset === "dnd_2024" ? "Bonus Action" : "Action", resourceId: "lay-on-hands", summary: "Havuzdan puan harcayarak hedefi iyileştir." }, ...(level >= 3 ? [{ id: "channel-divinity", name: "Channel Divinity", actionType: "Action", resourceId: "channel-divinity", summary: "Paladin oath Channel Divinity seçeneğini kullan." } as ClassFeatureAction] : [])],
