...
const magicItems: DndItemData[] = [
  ...
  {id:"eyes-of-charming",name:"Eyes of Charming",category:"gear",cost:"uncommon",weight:0,magical:true,rarity:"uncommon",requiresAttunement:true,charges:3,chargeRecovery:"daily",description:"Charge harcayarak charm etkisi dener."},
