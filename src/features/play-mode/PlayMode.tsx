...
export function PlayMode({
  ...
  const armorClass=Math.max(baseArmorClass+itemEffectRuntime.armorClassBonus+advancedFeatRuntime.armorClassBonus,subclassRuntime.armorClassFloor);
