...
export function PlayMode({
  ...
  const handledResourceIds=new Set(["sorcery-points","wild-shape","superiority-dice","focus-points","bardic-inspiration","second-wind","action-surge","indomitable","channel-divinity","arcane-recovery"]);
