...
$required = @(
  ...
  'src\core\rulesets\inventoryEquipmentRuntime-N-MEGA8.test.ts',
  'src\core\rulesets\multiclassAdvancementRuntime-N-MEGA9.test.ts',
  'src\core\rulesets\playStatusRuntime-N-MEGA10.test.ts',
  'src\core\rulesets\universalFeatureRuntime-N-MEGA11.test.ts'
)
...
Write-Host 'N-MEGA12 HOTFIX1 FINAL GREEN'
